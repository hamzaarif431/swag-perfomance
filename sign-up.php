            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-sm-12 col-md-12 col-lg-7 col-xl-7 col-xxl-7">
                    <form action="" class="login-form">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                <h5 class="form-h">Sign Up</h5>
                                <p class="form-p">Already Have An Account?<a href="login.php" class="signup-a">Log In</a></p>
                            </div>
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                <label for="" class="custom-label">Confirm Password</label>
                                <input type="text" class="form-control custom-control"
                                    placeholder="enter password">
                            </div>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
