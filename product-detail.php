            ...
            <div class="row justify-content-between">
                <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 col-xxl-5">
                    ...
                    <div class="swiper-container gallery-top">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="images/power-stroke/sliderl1.png" class="swiper-main-img">
                            </div>
                            <div class="swiper-slide">
                                <img src="images/power-stroke/sliderl1.png" class="swiper-main-img">
                            </div>
                    ...
                    <div class="swiper-container gallery-thumbs">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="images/power-stroke/sliders1.png" class="swiper-main-small">
                            </div>
                            <div class="swiper-slide">
                                <img src="images/power-stroke/sliders2.png" class="swiper-main-small">
                            </div>
                            <div class="swiper-slide">
                                <img src="images/power-stroke/sliders3.png" class="swiper-main-small">
                            </div>
                            <div class="swiper-slide">
                                <img src="images/power-stroke/sliders4.png" class="swiper-main-small">
                            </div>
                    ...
                    <div class="product-detail-desc">
                        ...
                        <div class="add-cart">
                            <div class="row align-items-center justify-content-between">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4">
                                    <a href="cart.php" class="btn cart-btn">add to cart</a>
                                </div>
                                <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4">
                    ...
                    <div class="tab-content categ-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane categ-pane animate__animated animate__jackInTheBox animate__fast"
                            ...
                            <div class="reviews-main">
                                ...
                                <div class="row align-items-center justify-content-between">
                                    <div
                                        class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6 px-xxl-5 px-xl-5 px-lg-5">
